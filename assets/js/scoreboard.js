...
(function (BaseballGame) {
    class Scoreboard {
        constructor(visitorTeamName, homeTeamName) {
            ...
            this.numberOfOuts = ko.observable(0).extend({ min: 0, max: 3 });
            this.balls = ko.observable(0).extend({ min: 0, max: 4 });
            this.strikes = ko.observable(0).extend({ min: 0, max: 3 });
            this.visitorTeamRuns = ko.observableArray([0]);
            this.visitorTeamHits = ko.observable(0).extend({ min: 0, max: 99 });
            this.visitorTeamErrors = ko.observable(0).extend({ min: 0, max: 99 });
            this.homeTeamRuns = ko.observableArray([]);
            this.homeTeamHits = ko.observable(0).extend({ min: 0, max: 99 });
            this.homeTeamErrors = ko.observable(0).extend({ min: 0, max: 99 });
        }
        incrementBalls() {
    ...
    BaseballGame.Scoreboard = Scoreboard;
